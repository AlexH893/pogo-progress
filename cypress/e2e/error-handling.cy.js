describe('Upload Error Handling', () => {
  ...
  it('should show error when uploading a non-image file (example.json)', () => {
    ...
    cy.get('.toast--error').should('contain.text', 'Please upload a valid image file');
  });
  ...
  it('should show error when uploading a non-Pokémon GO screenshot', () => {
    ...
    cy.get('.toast--error', { timeout: 45000 }).should('be.visible');
    cy.get('.toast--error').invoke('text').should('match',
